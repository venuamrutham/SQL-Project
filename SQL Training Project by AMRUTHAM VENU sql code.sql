...
/* 4) i. Write a query to fetch EMP_ID, FIRST_NAME, LAST_NAME, GENDER, DEPARTMENT, and EMP_RATING less than 2 */
...
/* 5) Write a query to concatenate the FIRST_NAME and the LAST_NAME of employees in the Finance department from the 
